<template>
  <div class="flex flex-col min-h-screen bg-gray-100">
    <Header title="Requisições - Conferência" />
    ...
    <div class="content-wrapper">
      <div class="table-container">
        ...
        <table class="responsive-table">
          ...
          <tbody>
            <tr v-if="requisicoes.length === 0"><td colspan="4" class="text-center py-10 text-gray-500">Nenhuma requisição aguardando conferência.</td></tr>
            <tr v-for="req in requisicoes" :key="req.id_requisicao">
              ...
              <td data-label="Ações" class="text-center">
                <button @click="iniciarConferencia(req)" class="button-primary text-xs" :disabled="loadingStates[req.id_requisicao]">
                  {{ loadingStates[req.id_requisicao] ? 'Aguarde...' : 'Iniciar Conferência' }}
                </button>
              </td>
            </tr>
          </tbody>
